...
const MOBS = [
  ...
  },
  {
    ...
    img: `${MC_WIKI}/Warden_JE1_BE1.png`,
    hp: 500,
    dmg: "15+ Hearts",
    biome: "Deep Dark",
    glow: "#00cccc",
...
const BLOCKS = [
  ...
  { name: "Obsidian",        img: `${MC_WIKI}/Obsidian_JE2.png` },
  { name: "Ancient Debris",  img: `${MC_WIKI}/Ancient_Debris_JE1_BE1.png` },
  { name: "Sculk",           img: `${MC_WIKI}/Sculk_JE1_BE1.png` },
  { name: "Netherrack",      img: `${MC_WIKI}/Netherrack_JE2_BE1.png` },
  { name: "End Stone",       img: `${MC_WIKI}/End_Stone_JE2.png` },
  { name: "Crying Obsidian", img: `${GH}/block/crying_obsidian.png` },
];
