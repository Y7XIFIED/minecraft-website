...
const MOBS = [
  ...
  { name: "Zombie",   tag: "Hostile",  img: `${W}/Zombie_JE5_BE2.png`,   desc: "Pursues survivors relentlessly. Susceptible to sunlight exposure.",     hp: 20,  dmg: "2.5 hearts", glow: "#1a3320" },
...
const GAMES = [
  ...
  { id: "clicker", label: "Mob Clicker", desc: "Quickly click mobs to earn points before the timer runs out.", icon: `${W}/Zombie_JE5_BE2.png` },
